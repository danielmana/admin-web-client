...
class OperationsDecision extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
    ...
    renderBusinessStatus(value) {
        return (
            <TextField
                name="status"
                value={value || ''}
                floatingLabelText="Business status"
                style={styles.item}
                disabled
            />
        );
...
OperationsDecision.propTypes = {
    operationsDecision: PropTypes.oneOfType([
        PropTypes.array,
        PropTypes.object,
    ]),
};

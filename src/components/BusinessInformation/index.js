...
import { EMPLOYEES, BUSINESS_STRUCTURE, MAJOR_MINOR_INDUSTRY, INDUSTRY_SPLIT_SIGN } from './constants';
...
class BusinessInformation extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
    ...
    handleInitialization(businessInfo) {
        ...
        this.handleMajorIndustryChange(head(split(businessInfo.industry, INDUSTRY_SPLIT_SIGN))); /* call to update minor industry according to major industry */
    }
    ...
    renderBusinessStatus() {
        ...
        return (
            <FormFieldBusinessStatus
                value={formValues && formValues.toJS().businessStatus}
                disabled={this.state.disabled}
            />
        );
    }

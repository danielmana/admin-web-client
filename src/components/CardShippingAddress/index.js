...
class CardShippingAddress extends React.PureComponent {
      ...
      <div>
        <form onSubmit={handleSubmit(this.handleSubmit)}>
          ...
          <Card>
            ...
            <div style={styles.row}>{this.renderZip()}</div>
          </Card>
        </form>
  ...
  renderAddressOne() {
    return (
      <Field name="shippingAddressOne" label="Address 1" component={FormTextField} disabled={this.state.disabled} />
    );
  }

  renderAddressTwo() {
    return (
      <Field name="shippingAddressTwo" label="Address 2" component={FormTextField} disabled={this.state.disabled} />
    );
  }

  renderCity() {
    return <Field name="shippingCity" label="City" component={FormTextField} disabled={this.state.disabled} />;
  }
  ...
  renderZip() {
    return <Field name="shippingZip" label="Zip" component={FormTextField} disabled={this.state.disabled} />;
  }
}

...
class FormContentPatient extends React.Component {
  ...
  renderFirstName() {
    ...
    return <Field autoFocus style={styles.field} name={name} label="First name" component={FormTextField} />;
  }

  renderLastName() {
    const { fieldsPrefix } = this.props;
    const name = `${fieldsPrefix}lastname`;
    return <Field style={styles.field} name={name} label="Last name" component={FormTextField} />;
  }
  ...
  renderLanguage() {
    ...
    return <Field name={name} label="Contact language" options={languageOptions} component={FormSelectField} />;
  }
  ...
  renderDoNotContact() {
    ...
    return (
      <div style={{ margin: '20px 0' }}>
        <Field name={name} label="Do not contact" component={FormCheckbox} />
      </div>
    );
  }
  ...
  renderContactValue() {
    ...
    return <Field style={styles.field} name={name} label={label} component={FormTextField} />;
  }
}

...
export class EnrollmentsPage extends React.PureComponent {
...
const withForm = reduxForm({
  form: 'EnrollmentsPageForm',
});

const withReducer = injectReducer({ key: 'enrollmentsPage', reducer });
const withSaga = injectSaga({ key: 'enrollmentsPage', saga });
